...
public class CandidateCombination {
	 ...
	 * 不同种子词相应的候选集合
	 */
	private Set<MPage> candiDateSet;
	/**
	 * 该候选集合的概率得分
	 */
	...
	public CandidateCombination(){
		candiDateSet = new HashSet<MPage>();
	}
	 ...
	 * @param page 要添加的候选条目
	 */
	public void addCandidate(MPage page){
	...
	public Set<MPage> getCandiDateSet() {
		return candiDateSet;
	}
	public void setCandiDateSet(Set<MPage> candiDateSet) {
